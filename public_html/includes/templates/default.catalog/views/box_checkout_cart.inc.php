...
<div id="box-checkout-cart">
  ...
  <ul class="shortcuts">
    ...
    <li class="shortcut">
      <a href="#" style="list-style:none; display:inline-block; text-align: center;"><img src="<?php echo htmlspecialchars($item['thumbnail']); ?>" style="max-width: 42px; max-height: 32px" /></a>
    </li>
    <?php } ?>
  </ul>
  <script>

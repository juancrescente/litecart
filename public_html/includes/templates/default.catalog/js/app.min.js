$(document).ready(function(){$('[data-toggle="tooltip"]').tooltip();var sidebar_offset_y=$('.sidebar + .content').scrollTop()+$('.sidebar + .content').offset().top;$('.sidebar + .content').css('min-height',$('.sidebar').height());$('.sidebar').css('position','fixed').css('top',sidebar_offset_y+'px');$(window).resize(function(e){sidebar_offset_y=$('.sidebar + .content').scrollTop()+$('.sidebar + .content').offset().top;});$(window).scroll(function(e){var scrolled=$(window).scrollTop();$('.sidebar').css('top',(sidebar_offset_y-(scrolled*0.65))+'px');});(function($){$.fn.animate_from_to=function(targetElm,options){return this.each(function(){animate_from_to(this,targetElm,options);});};$.extend({animate_from_to:animate_from_to});function animate_from_to(sourceElm,targetElm,options){var source=$(sourceElm).eq(0),target=$(targetElm).eq(0);var defaults={pixels_per_second:1000,initial_css:{"background":"#dddddd","opacity":0.8,"position":"absolute","top":source.offset().top,"left":source.offset().left,"height":source.height(),"width":source.width(),"z-index":100000,"image":""},square:'',callback:function(){return;}}

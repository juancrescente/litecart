$(document).ready(function(){$('[data-toggle="tooltip"]').tooltip();if($('.sidebar').height()<$('.sidebar + .content').height()){var sidebar_offset_y=$('.sidebar + .content').scrollTop()+$('.sidebar + .content').offset().top;$('.sidebar + .content').css('min-height',$('.sidebar').height());$('.sidebar').css('position','fixed').css('top',sidebar_offset_y+'px');$(window).resize(function(e){sidebar_offset_y=$('.sidebar + .content').scrollTop()+$('.sidebar + .content').offset().top;});$(window).bind('resize scroll',function(e){var scrolled=$(window).scrollTop();$('.sidebar').css('top',(sidebar_offset_y-(scrolled*0.65))+'px');});}

...
CREATE TABLE `lc_products` (
  ...
  `keywords` varchar(256) NOT NULL,
  `code` varchar(64) NOT NULL,
  `sku` varchar(64) NOT NULL COMMENT 'Moved to lc_products_stock as of version 1.4',
  ...
  `weight` decimal(10,4) NOT NULL COMMENT 'Moved to lc_products_stock as of version 1.4',
  `weight_class` varchar(2) NOT NULL COMMENT 'Moved to lc_products_stock as of version 1.4',
  `dim_x` decimal(10,4) NOT NULL COMMENT 'Moved to lc_products_stock as of version 1.4',
  `dim_y` decimal(10,4) NOT NULL COMMENT 'Moved to lc_products_stock as of version 1.4',
  `dim_z` decimal(10,4) NOT NULL COMMENT 'Moved to lc_products_stock as of version 1.4',
  `dim_class` varchar(2) NOT NULL COMMENT 'Moved to lc_products_stock as of version 1.4',

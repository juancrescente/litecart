...
<?php echo functions::form_draw_protected_form_begin('tax_class_form', 'post', false, false, 'style="max-width: 640px;"'); ?>
  ...
  <div class="row">
    <div class="form-group col-md-6">
      <label><strong><?php echo language::translate('title_code', 'Code'); ?></strong></label>
      <?php echo functions::form_draw_text_field('code', true, 'data-size="small"'); ?>
    </div>
    
    <div class="form-group col-md-6">
      <label><strong><?php echo language::translate('title_name', 'Name'); ?></strong></label>
  ...
  <div class="row">
    <div class="form-group col-md-12">
      <label><strong><?php echo language::translate('title_description', 'Description'); ?></strong></label>

  ...
  <script>
    ...
    function addItem(item) {
      ...
      var output = '  <tr class="item">'
                 ...
                 + '    <td style="text-align: center;"><?php echo functions::general_escape_js(functions::form_draw_warehouses_list('items[new_item_index][warehouse_id]', settings::get('default_warehouse_id'))); ?></td>'

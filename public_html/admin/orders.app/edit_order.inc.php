...
?>
  ...
  <div class="row">
    <div class="form-group form-inline col-md-12 text-right">
...
// Order items
  ...
  $('select[name="language_code"], select[name="currency_code"], input[name="currency_value"], input[name="customer[company]"], select[name="customer[country_code]"], select[name="customer[zone_code]"]').bind('click change input', function(e){
    $('#order-items .add-product').attr('href', '<?php echo document::link(null, array('doc' => 'add_product'), array('app')); ?>' + '&language_code=' + $('select[name="language_code"]').val() + '&currency_code=' + $('select[name="currency_code"]').val() + '&currency_value=' + $('input[name="currency_value"]').val() + '&customer%5Bcountry_code%5D=' + $('select[name="customer[country_code]"]').val() + '&customer%5Bzone_code%5D=' + ($('select[name="customer[zone_code]"]').val() ? $('select[name="customer[zone_code]"]').val() : "") + '&customer%5Bcompany%5D=' + encodeURIComponent($('input[name="customer[company]"]').val()));
    $('#order-items .add-custom-item').attr('href', '<?php echo document::link(null, array('doc' => 'add_custom_item'), array('app')); ?>' + '&language_code=' + $('select[name="language_code"]').val() + '&currency_code=' + $('select[name="currency_code"]').val() + '&currency_value=' + $('input[name="currency_value"]').val() + '&customer%5Bcountry_code%5D=' + $('select[name="customer[country_code]"]').val() + '&customer%5Bzone_code%5D=' + $('select[name="customer[zone_code]"]').val() + '&customer%5Bcompany%5D=' + encodeURIComponent($('input[name="customer[company]"]').val()));
  }).trigger('change');

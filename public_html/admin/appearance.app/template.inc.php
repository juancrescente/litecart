    ...
    <div class="form-group col-md-2">
      <label><?php echo language::translate('title_catalog_template', 'Catalog Template'); ?></label>
        <div class="input-group">
          ...
          <a class="input-group-addon" href="<?php echo document::href_link(WS_DIR_ADMIN, array('doc' => 'template_settings'), array('app')); ?>" alt="<?php language::translate('title_settings', 'Settings'); ?>"><?php echo functions::draw_fonticon('fa-wrench fa-lg'); ?></a>
        </div>
    </div>
  </div>
